		...
		return {
			...
			courses: [
				...
				},
				{
					...
					desc:
						"Опытный педагог поможет подготовится к единому государственному экзамену (ЕГЭ) по информатике",
					merits: [
						"Быстро Выполнять тестовые задания;",
						"Изучит язык программирования C++;",
						"Научитьсярешать решать задачи с помощью программирования;",
						"Решать задания повышенного уровня. Готовым нужно быть ко всему!;",
				...
				},
				{
					...
					img: "./courses_logos/logo_informatics.svg",
					desc:
						"Опытный педагог поможет подготовится к общему государственному экзамену (ОГЭ) по информатике",
					merits: [
						"Быстро Выполнять тестовые задания;",
						"Изучит язык программирования C++;",
						"Научитьсярешать решать задачи с помощью программирования;",
