			...
			courses: [
				{
					...
					desc:
						"Опытный педагог поможет подготовится к единому государственному экзамену (ЕГЭ)",
					merits: [
						"Рещать тестовые задания",
						"Решать геометрические задачи",
						"Решать тригонометрические уравнения, неравенства и задания с парамером",
